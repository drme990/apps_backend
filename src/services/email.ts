...
function buildEmailHtml(order: IOrder): string {
  ...
  const statusUrl = `${brand.siteUrl}/payment/status?orderNumber=${order.orderNumber}`;
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.10);">
          ...
          <tr>
            <td style="padding:0 30px 24px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f9fa;border-radius:8px;border:1px solid #eee;">
                <tr>
                  <td style="padding:12px 16px;font-size:13px;color:#555;border-bottom:1px solid #eee;">
                    <span style="font-weight:bold;color:#1a1a2e;">${L.orderNumber}</span>
                  </td>
                ...
                <tr>
                  <td style="padding:12px 16px;font-size:13px;color:#555;">
                    <span style="font-weight:bold;color:#1a1a2e;">${L.orderDate}</span>
                  </td>
          ...
          <tr>
            <td style="padding:0 30px 24px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border-top:2px solid ${brand.primaryColor};">
                ${payRows}
              </table>
            </td>
          </tr>
